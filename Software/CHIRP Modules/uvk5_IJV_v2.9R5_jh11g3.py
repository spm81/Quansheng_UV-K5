...
# jh11g aggiunta Band A/B TX 
# jh11g1 aggiunta banda singola enable
# jh11g2 aggiunta satcom
# jh11g3 aggiunto satcom e upconverter
...
######################################### 0xF4F ###########################################################################           
            ...
            if element.get_name() == "satcom":
                tmp_satcom = element.value and 0x06 or 0x00 
                sv3 = True 

             # Upconv
            if element.get_name() == "upconv":
                tmp_upconv = element.value and 0x08 or 0x00 
                sv4 = True 
...
################################################# 0xF4F ##########################################################################
        ...
        rs = RadioSetting(
                "satcom",
                "SATCOM", RadioSettingValueBoolean(bool((_mem.satcom & 0x06) > 0)))
        basic.append(rs)

        # Upconv
        rs = RadioSetting(
                "upconv",
                "UP Converter", RadioSettingValueBoolean(bool((_mem.upconv & 0x08) > 0)))
        basic.append(rs)
