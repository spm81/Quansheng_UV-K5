...
* A = [Based on OneofEleven Firmware](https://github.com/OneOfEleven/uv-k5-firmware-custom)
...
**MCFW V0.23A** - Based on Open Spectrum Firmware - Based on OneofEleven OEFW-ca78b74 with facgi Spectrum OSFW-c0ca69e ( FM RADIO Disable + VOX Disable + Added Roger Beep Motorola on the Menu + improvement in SATCOM reception + ALL TX )<br>
