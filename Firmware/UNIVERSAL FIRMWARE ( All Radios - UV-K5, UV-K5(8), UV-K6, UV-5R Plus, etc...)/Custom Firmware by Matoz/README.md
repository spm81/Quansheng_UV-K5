...
**MCFW V0.31.5C** - Based on Open Spectrum Firmware - Facgi Spectrum OSFW-c8ae8a5 ( Same as MCFW V0.31.2C, but with power transmitter calibration, applied to frequencies 137 MHz to 173.990 MHz and 400 MHz to 469.990 MHz. Need Password: 123400) <br>
